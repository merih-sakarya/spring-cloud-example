...
This project has been developed in line with the needs of our project, drawing significant inspiration and guidance from the [docker-elk][docker-elk] project. A big thanks to the community for their great work.
...
Initialize the Elasticsearch users and groups required by docker-elk by executing the command:
